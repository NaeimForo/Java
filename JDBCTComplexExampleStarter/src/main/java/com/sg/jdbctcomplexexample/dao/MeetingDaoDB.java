...
public class MeetingDaoDB implements MeetingDao {
    ...
    public Meeting getMeetingByid(int id) {
        try {
            final String SELECT_MEETING_BY_ID = "SELECT * FROM meeting WHERER id = ?";
    ...
    public Meeting addMeeting(Meeting meeting) {
        ...
        int newId = jdbc.queryForObject("SLECT LAST_INSERT_ID()", Integer.class);
        meeting.setId(newId);
    ...
    public List<Meeting> getMeetingsForEmployee(Employee employee) {
        final String SELECT_MEETING_FOR_EMPLOYEE = "SELECT * FROM meeting m "
                +"JOIN meeting_employee me ON m.id = me.meetingId WHERE me.employeeId = ?";
        List<Meeting> meetings = jdbc.query(SELECT_MEETING_FOR_EMPLOYEE,
    ...
    private List <Employee> getEmployeesForMeeting(Meeting meeting){
        final String SELECT_EMPLOYEES_FOR_MEETING = "SELECT e.* FROM employee e"
                +"JOIN meeting_employee me ON e.employeeId = me .employeeId WHERE me.meetingId = ?";
